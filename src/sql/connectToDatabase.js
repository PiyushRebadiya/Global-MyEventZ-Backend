...
const config = {
    ...
    options: {
        encrypt: true, // Set this to true to enable encryption
        trustServerCertificate: true, // Use true for development; set false for production if using a valid certificate
    }
  };
