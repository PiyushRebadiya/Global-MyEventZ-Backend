...
const OrginazerMaster = async (req, res)=>{
    const { OrganizerName = '', OrganizerUkeyId = generateUUID(), StateCode = '', StateName = null, Email = null, Mobile1 = null, Mobile2 = null, AliasName = null, Description = null, Add1 = null, Add2 = null, City = null, IsActive = true, UsrID = null, UPI = null, flag = null, UserName = null,
    ...
    try{
        ...
        const insertQuery = `
            INSERT INTO OrganizerMaster (OrganizerUkeyId, OrganizerName, Mobile1, Mobile2, Email, AliasName, Description, Add1, Add2, City, StateCode, StateName, UPI, IsActive, UsrID, IpAddress, HostName, EntryDate, flag, UserName, Password, Role, RazorpayKeyId, RazorpaySecretKey, RazorpayBusinessName) VALUES (
